...
- Interfaz V0 generada desde un esquema único: bindings Rust y C, fixtures y comprobador que verifica que lo generado coincide byte a byte con el esquema.
...
- Comprobador de la puerta K2: 16 criterios decididos por separado, 14 desde los registros del kernel, con la regresión de K1 como criterio propio y una autocomprobación de 16 ejecuciones dañadas.
- Registro de lo ejecutado, su alcance y sus límites en el vault, incluidos los siete defectos que solo aparecieron al ejecutar.
