...
EXP-01 está ejecutado; EXP-02, EXP-03, EXP-04, EXP-05 y EXP-06 lo están **en su alcance K3**, que es multiprocesador con un dispositivo virtio moderno y sin estado durable, sobre un emulador y **sin unidad de remapeo programada**. EXP-07 y EXP-08 están ejecutados **en su alcance K4**, y EXP-09 lo está **en su parte K4**: sobre un medio real conducido por el driver del invitado, con la supresión hecha en el invitado y no por el emulador. El resto está **pendiente**. Los modelos de diseño que ya se pueden ejecutar tienen nombres MODEL-01/02 y se reportan por separado.
